      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Room List</a>
          </div>
              ...
              <div class="card-body">
                <table class=" table tablesorter" id="">
				  ...
				  include "room.php";
					...
					echo   '<div class="row">';
					echo     '<div class="col-md-7 px-md-10">';
					echo        '<div class="form-group">';
					echo          '<label>Room Type : </label>';
					echo 			"<input type='text' name='roomType'>";
					echo        '</div>';
					echo      '</div>';
					...
					echo      '<div class="col-md-7 px-md-10">';
					echo        '<div class="form-group">';
					echo          '<label>Bed Type : </label>';
					echo 			"<input type='text' name='bedType'>";
					echo        '</div>';
					echo      '</div>';
					echo    '</div>';
					echo    '<div class="row">';
					echo      '<div class="col-md-7 px-md-10">';
					echo        '<div class="form-group">';
					echo          '<label>Price per night : </label>';
					...
					echo '<br><br><input type="submit" name="saveNewRoomButton" value="Save">';
