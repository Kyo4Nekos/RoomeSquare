...
<head>
    ...
    <title>Reset Your RoomeSquare Password</title>
    <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                                                <a href="http://localhost/masterfolder_roomesquare/Homepage/#contact" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #2a2a2a;
 font-weight: normal; text-decoration: none" target="_blank" title="RoomeSquare is for K Boutique Hotel room reservation.">
                                                                    <p align="none" height="32" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 text-decoration: none; height: auto; width: 200px; height: 32px; margin: 0px; font-size:200%; color:white; font-family:Franklin Gothic Heavy" width="107">ROOMESQUARE</p>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-sm-offset-3">
                                            ...
                                            <form method="post" action="">
												<input type="email" class="input-lg form-control" name="email" id="password1" placeholder="Email" autocomplete="off"><br>
                                                ...
                                                <input type="password" class="input-lg form-control" name="password" id="password2" placeholder="Repeat Password" autocomplete="off">
                                                <div class="row">
                                                    <div class="col-sm-12">
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                                                                <button class="mcnButton " name="Go" type="submit" style="mso-line-height-rule: exactly;
 ...
 #FFFFFF; text-transform:uppercase;" target="_blank">Reset password</button>
 </form>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
 ...
 font-weight: normal; text-decoration: none; color:#7F6925;" target="_blank" title="Noun Project - Icons for Everything">K Boutique Hotel</a></div>
                                                            </td>
                                                        </tr>
                                                    <tbody></tbody>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%">
                                                <a href="https://www.facebook.com/kboutiquehoteltelukintan/" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #f57153; font-weight: normal; text-decoration: none" target="_blank">
                                                    <img alt="facebook" height="32" src="https://static.lingoapp.com/assets/images/email/facebook-ic-32x32-email@2x.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none; text-decoration: none" width="32" />
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
...
if (isset($_POST['Go'])) {
	print_r($_POST);
    $to = $_POST['email'];
    $subject = 'RoomeSquare Notification | Forget Password';
    $message = '
        ...
        http://localhost/masterfolder_roomesquare/forgetPass/repforget.php?email=' . $_POST['email'] . '&password=' . $_POST['password'] . '
