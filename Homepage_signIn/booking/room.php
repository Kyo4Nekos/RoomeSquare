            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            ...
                            <h3>RM 110<span>/Pernight</span></h3>
                            <table>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>10" Thick Mattress with Comfort Plush Top, Complimentary WIFI Access, 32" LCD TV, 
                                            Alarm Clock, Complimentary Drinking Water, 
                                            Coffee & Tea Maker, En Suite Bathroom with Shower, Ironing Facilities,
                                            Desk & Open Shelf and Key-Card Door Access</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            ...
                            <h3>RM 140<span>/Pernight</span></h3>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="r-o">Capacity:</td>
                                    ...
                                    <tr>
                                        <td class="r-o">Services:</td>
                                        <td>10" Thick Mattress with Comfort Plush Top, Complimentary WIFI Access, 
                                            32" LCD TV, Alarm Clock, Complimentary Drinking Water, 
                                            Coffee & Tea Maker, En Suite Bathroom with Shower, Ironing Facilities, 
                                            Desk & Open Shelf and Key-Card Door Access</td>
                                    </tr>
                                </tbody>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            <h4>Premium Triple Room</h4>
                            <h3>RM 160<span>/Pernight</span></h3>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="r-o">Capacity:</td>
                                    ...
                                    <tr>
                                        <td class="r-o">Bed:</td>
                                        <td>1 Single Bed + 1 Queen Bed</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Services:</td>
                                        <td>1 Single Bed + 1 Queen Bed
                                            Room Fact: 10" Thick Mattress with Comfort Plush Top, Complimentary WIFI Access, 32" LCD TV, 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            ...
                            <h3>RM 180<span>/Pernight</span></h3>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="r-o">Capacity:</td>
                                    ...
                                    <tr>
                                        <td class="r-o">Services:</td>
                                        <td>10" Thick Mattress with Comfort Plush Top, Complimentary WIFI Access, 32" LCD TV, Alarm Clock, 
                                            Complimentary Drinking Water, Coffee & Tea Maker, En Suite Bathroom with Shower, Ironing Facilities, 
                                            Desk & Open Shelf and Key-Card Door Access</td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            <h4>Standard Double Platform Room (Tatami Style) </h4>
                            <h3>RM 110<span>/Pernight</span></h3>
                            <table>
                                <tbody>
                                    <tr>
