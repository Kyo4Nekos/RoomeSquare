                        ...
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                        ...
                                        <li><a href="facility/facility.html">Facility</a></li>
                                        <li><a href="booking/contact.html">Contact Us</a></li>
                                        <li><a href="../customerlogin/index.html">Sign In</a></li>
                                </ul>
                            </nav>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="hero-text">
                        ...
                        <p>Our hotel conveniently set in the town of Teluk Intan, located along Jalan Sungai Manik. 
                        We are just a 10 minutes drive to town where the famous tourist 
                        attraction leaning clock tower ‘Menara Condong’ is situated.</p>
                    </div>
                </div>
